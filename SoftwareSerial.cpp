...
// (courtesy of Arduino forum user *etracer*)
  ...
  if (_inverse_logic ? rx_pin_read() : !rx_pin_read())
  {
    ...
    // skip the stop bit
    tunedDelay(_rx_delay_stopbit * _num_end_bits);
    DebugPulse(_DEBUG_PIN1, 1);
...
// Constructor
//
SoftwareSerial::SoftwareSerial(uint8_t receivePin, uint8_t transmitPin, bool inverse_logic /* = false */, uint8_t num_end_bits /* = 1 */) : 
